...
Fire.prototype.drawTxt = function () {
	...
	this.ctx.strokeText("Heartflame Software", this.canvas.width / 2, this.canvas.height * .60);
	this.ctx.fillText("Heartflame Software", this.canvas.width / 2, this.canvas.height * .60);
	this.ctx.restore();
}
